  ...
  return (
    <div className="w-screen min-h-screen overflow-x-hidden bg-slate-50 font-sans">
      ...
      <section className="relative w-screen h-[85vh] ">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-slate-950/90 to-slate-950/40 flex flex-col justify-center">
          <div className="max-w-7xl mx-auto px-10 lg:px-24 w-full text-white">
            <h2 className="text-sm font-bold tracking-widest text-sky-400 uppercase mb-3">Exclusive Gatherings</h2>
            <h1 className="text-3xl md:text-4xl font-extrabold mb-6 tracking-tight line-clamp-3 drop-shadow-lg">
              Private Parties <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-white">in Karnataka</span>
            </h1>

            <p className="mb-10 text-xl font-light text-slate-200 max-w-2xl leading-relaxed">
              Experience the pinnacle of luxury celebrations. Spark Movement elegantly designs and executes immaculate private events tailored perfectly to you.
            </p>
            ...
            <div className="flex gap-6 flex-wrap">
              ...
              <a
                href="https://wa.me/9986146509/?text=Hello%20Spark%20Movement%20Karnataka%2C%20I%20am%20interested%20in%20your%20Private%20Parties%20services.%20Please%20provide%20more%20details."
                target="_blank"
      ...
      <section className="py-24 px-10 md:px-24 bg-white relative">
        <div className="absolute top-0 left-0 w-1/3 h-1/3 bg-indigo-100/30 rounded-br-[100px] pointer-events-none"></div>

        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
          <div className="order-2 md:order-1 flex flex-col justify-center">
            <h2 className="text-sm font-bold tracking-widest text-sky-500 uppercase mb-3">Immaculate Detail</h2>
            <h3 className="text-3xl md:text-3xl font-extrabold text-slate-900 mb-8 leading-tight">
              Extraordinary <br /> <span className="text-sky-600">Celebrations</span>
            </h3>

            <p className="text-lg text-slate-600 font-light leading-relaxed mb-6">
              At Spark Movement, we fiercely believe your private party shouldn't just be an event—it must be an absolute masterpiece. We transform intimate gatherings into sprawling, breathtaking luxurious spectacles.
            </p>

            <p className="text-lg text-slate-600 font-light leading-relaxed">
              From bespoke themed décor and masterful mixology stations to elite, seamless event coordination, our dedicated private concierge team ensures total perfection in every moment.
            </p>
          </div>
      ...
      <section ref={servicesRef} className="w-screen px-10 md:px-24 py-24 bg-slate-50">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h3 className="text-3xl font-extrabold text-slate-900">Custom Party Experiences</h3>
        </div>
            ...
            >
              ...
              <div className="p-8 flex-grow flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-slate-500 font-light text-sm line-clamp-3 mb-6">Redefine your celebration aesthetics and push boundaries with this exclusive premium private service.</p>
                </div>
